...
Verified against all 75 records on 2026-08-20. Where this file and a habit
...
- 75 records exist; the highest number is **154**. Numbering is sparse —
...
Optional:
- `## Notes` — used by 39 of 75 records. Not a defect when absent.
...
## Status vocabulary
- `Proposed` — drafted, not agreed (6 records)
...
- Six records sit at `proposed`: ADR-150–154 (security, written and reviewed
  2026-08-02) and ADR-003's predecessors where noted. Proposed is a real
  state here, not a stalled draft.
